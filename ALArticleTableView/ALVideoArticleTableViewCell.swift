...
public class ALVideoArticleTableViewCellSetting : ALArticleTableViewCellSetting {
    public var sizeThumbnail = CGSize(width: 172.0, height: 106.0)
...
public class ALVideoArticleTableViewCell : ALArticleTableViewCell {
    private let setting: ALVideoArticleTableViewCellSetting
    ...
    public init(video setting: ALVideoArticleTableViewCellSetting) {
